      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <section className="mb-32">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[1, 2].map((i) => (
              <motion.div key={i} whileHover={{ y: -5 }} className="artisan-card p-10 border-none bg-white shadow-xl relative overflow-hidden">
                ...
                <p className="text-muted-foreground text-lg leading-relaxed italic relative z-10">
                  "The attention to detail in this {product.category.toLowerCase()} piece is breathtaking. You can truly feel the story behind it."
                </p>
              </motion.div>
            ))}
          </div>
